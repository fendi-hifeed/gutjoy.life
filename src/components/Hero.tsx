...
export default function Hero() {
  ...
  const whatsappLink = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
    lang === "id"
      ? "Halo GutJoy! Saya tertarik untuk membeli yogurt. Bisa info produk dan harga?"
      : "Hello GutJoy! I'm interested in buying yogurt. Can I get product and price info?"
  )}`;
